...
const codeHead = '<link rel="icon" type="image/png" href="./favicon.ico" sizes="256x256">\n\
  <link rel="manifest" href="./minmaxtool.webmanifest" />\n\
  <meta charset="utf-8">\n\
  <meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1" />\
  <meta name="description" content="A tool to optimize your ships, missiles, and strategies.">\
